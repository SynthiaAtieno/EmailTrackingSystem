...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
    ...
    if (isset($_GET['replied_id'])) {
      $id = $_GET['replied_id'];
      $sql = "UPDATE requests SET status_id='2' WHERE user_id=$_SESSION[user_id] AND id=$id";
...
<div class="container-fluid">
  <!--Cards-->
    <div class="row mb-3">
      <div class="col-md-12 fw-bold text-uppercase fs-4">Replied Emails
    </div>
    <div class="row">
            ...
            <div class="col-md-12">
                <div class="card mt-5 border-0">
                    <div class="card-header">
                        <h1 class="display-6 text-center fw-bold fs-4">Replied Mails</h1>
                    </div>
                    <div class="card-body">
                    <div>
                      Search:&nbsp;<input class="mb-4" type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for requests..">
                        ...
                        <table class="table text-center table-striped" id="myTable">
                            ...
                            <a href='pending_mails.php?id="<?php $replied_id = $row['id'];
                                echo $replied_id;?>"' class="btn btn-success" >Mark as Pending</a>&nbsp;&nbsp;
